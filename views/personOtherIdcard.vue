<template>
    <div class="personOtherIdcard" ref="personOtherIdcard">
        ...
        <el-breadcrumb separator-class="el-icon-arrow-right">
            ...
            <el-breadcrumb-item class="is-link">个人其他证件<i class="el-icon-refresh resetBtnIcon" @click="resetSelect"></i>
            </el-breadcrumb-item>
        </el-breadcrumb>
            ...
            <div>
                ...
                <div class="infoDialog ownerInfoDialog" v-show="infoDetail.name" v-if="tabPosition != '1'">
                    ...
                    <div>
                        ...
                        <div v-show="infoDetail.videoScreenshotFirst && infoDetail.videoScreenshotSecond.length > 0">
                            <span>人像视频截图二</span><span class="blueBtn" @click="
                                downloadFile(
        ...
        <div class="tabContent">
            <div class="selectArea">
                <div>
                    ...
                    <el-select v-model="ispCode" filterable placeholder="运营商" v-bind:disabled="!listRole" multiple
                        collapse-tags clearable @change="setParameters">
                    ...
                    <el-select v-model="vehicleStatus" filterable placeholder="车辆状态" v-bind:disabled="!listRole" multiple
                        @change="setParameters" clearable collapse-tags>
                        <el-option v-for="item in vehicleStatusOptions" :key="item.value" :label="item.label"
                            :value="item.value">
                        </el-option>
                    </el-select>
            ...
            <el-tabs v-model="activeName" type="card" @tab-click="tabClick">
                ...
                <el-dropdown v-if="tabPosition != '3' && tabPosition != '4'">
                    ...
                    <el-dropdown-menu slot="dropdown">
                        <el-dropdown-item v-if="activeName == 'first' && changeRole"
                            @click.native="checkList(true, true)">批量通过</el-dropdown-item>
                        <el-dropdown-item v-if="activeName == 'first' && changeRole"
                            @click.native="checkList(true, false)">批量拒绝</el-dropdown-item>
            ...
            <div class="infoArea">
                ...
                <el-table :data="infoList" border style="width: 100% ;height:fit-content;padding-bottom: 7px;"
                    ...
                    <el-table-column fixed="right" label="操作" width="110" align="center">
                        <template slot-scope="scope">
                            <span @click="opendrawer(scope.row, 'GR')" v-if="detailRole || changeRole"
...
export default {
    ...
    mounted() {
        ...
        this.exportRole = auth.hasPermi("home:personOtherIdcard:export");
        this.detailRole = auth.hasPermi("home:personOtherIdcard:detail");
        this.changeRole = auth.hasPermi("home:personOtherIdcard:change");
        this.listRole = auth.hasPermi("home:personOtherIdcard:list");
