<template>
  <div class="unitIdcard" ref="unitIdcard">
    ...
    <el-breadcrumb separator-class="el-icon-arrow-right">
      ...
      <el-breadcrumb-item class="is-link">单位证件<i class="el-icon-refresh resetBtnIcon" @click="resetSelect"></i>
      </el-breadcrumb-item>
    </el-breadcrumb>
      ...
      <div class="infoArea">
        ...
        <el-table :data="infoList" border style="width: 100% ;height:fit-content;padding-bottom: 7px;"
          ...
          <el-table-column fixed="right" label="操作" width="110" align="center">
            <template slot-scope="scope">
              <span @click="opendrawer(scope.row, 'DW')" v-if="detailRole || changeRole" class="btnBase blueBtn">详情</span>
        ...
        <!-- <div class="infoTable unit" v-if="tabPosition == '3'">
          <div class="tableHead">
            ...
            <span>
              <span>
                统一社会信用代码
                <img src="../assets/images/openEyes.png" v-show="false" v-if="orgCodeStatus" @click="changeHeadEyes('O')" />
                <img src="../assets/images/closeEyes.png" v-show="false" v-if="!orgCodeStatus"
                  @click="changeHeadEyes('O')" /></span></span>
            <span>单位证件类型</span>
            <span>
              <span>责任人证件号<img src="../assets/images/openEyes.png" v-show="false" v-if="cardNumbStatus" @click="changeHeadEyes('C')" />
            ...
            <span><span>责任人姓名
                ...
                <img src="../assets/images/closeEyes.png" v-show="false" v-if="!nameStatus" @click="changeHeadEyes('N')" /></span>
            </span>
...
export default {
  ...
  methods: {
    ...
    changeOrder(isFinish, num) {
      console.log(isFinish, num, '=========changeOrder==================')
      if (isFinish) {
        this.finishDesc = num;
        this.applyDesc = null;
      } else {
  ...
  mounted() {
    ...
    this.exportRole = auth.hasPermi("home:unitIdcard:export");
    this.detailRole = auth.hasPermi("home:unitIdcard:detail");
    this.changeRole = auth.hasPermi("home:unitIdcard:change");
    this.listRole = auth.hasPermi("home:unitIdcard:list");
