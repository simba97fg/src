<template>
  <div class="personCarUnbind" ref="personCarUnbind">
    ...
    <el-breadcrumb separator-class="el-icon-arrow-right">
      ...
      <el-breadcrumb-item class="is-link">个人车辆解绑<i class="el-icon-refresh resetBtnIcon" @click="resetSelect"></i>
      </el-breadcrumb-item>
    </el-breadcrumb>
    ...
    <el-dialog :visible.sync="refuseDialog" width="29.5%" center :show-close="false" style="padding-top: 15%"
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button @click="refuseDialog = false, refuseInput = null" v-if="activeName == 'first'">取 消</el-button>
    ...
    <div class="tabContent">
      <div class="selectArea">
        <div>
          <div>
            ...
            <el-input v-model="inputSelect" placeholder="请输入" v-bind:disabled="!listRole" @change="setParameters"
          ...
          <el-select v-model="newVehicleFlag" filterable placeholder="新车标识" v-bind:disabled="!listRole" multiple
            @change="setParameters" clearable collapse-tags>
          ...
          <el-select v-model="vehicleBrand" filterable placeholder="车辆品牌" v-bind:disabled="!listRole" multiple
            collapse-tags @change="setParameters" clearable>
          ...
          <el-select v-model="ispCode" filterable placeholder="运营商" v-bind:disabled="!listRole" multiple collapse-tags
            clearable @change="setParameters">
          ...
          <el-select v-model="ispType" filterable placeholder="车联网卡类型" v-bind:disabled="!listRole" multiple collapse-tags
            @change="setParameters" clearable>
        ...
        <div v-if="showMoreSelect">
          ...
          <el-select v-model="idType" filterable placeholder="证件类型" v-bind:disabled="!listRole" @change="setParameters"
            clearable>
            <el-option v-for="item in idTypeoptions" :key="item" :label="item" :value="item">
            </el-option>
          </el-select>
          <el-select v-model="channelType" filterable placeholder="渠道类型" v-bind:disabled="!listRole" multiple
            collapse-tags @change="setParameters" clearable>
      ...
      <div class="infoArea">
        ...
        <el-table :data="infoList" border style="width: 100% ;height:fit-content;padding-bottom: 7px;"
          v-if="activeName == 'second'" ref="multipleTable" @selection-change="handleSelectionChange" :key="activeName"
          @select-all="selectAll" class="realNameTable">
          ...
          <el-table-column prop="cardType" label="证件类型" width="180" align="center">
          </el-table-column>
          ...
          <el-table-column prop="ispName" label="运营商" width="180" align="center">
          </el-table-column>
          <el-table-column prop="vehicleBrand" label="车辆品牌" width="180" align="center">
          </el-table-column>
          <el-table-column prop="vehicleStatusName" label="车辆状态" width="180" align="center">
          </el-table-column>
          <el-table-column prop="newVehicleFlagName" label="新车标识" width="180" align="center">
          </el-table-column>
          <el-table-column prop="channelTypeName" label="渠道类型" width="140" align="center">
          </el-table-column>
          <el-table-column prop="ispTypeName" label="车联网卡类型" width="180" align="center">
          </el-table-column>
          <el-table-column fixed="right" label="操作" width="110" align="center">
            <template slot-scope="scope">
              <span @click="opendrawer(scope.row, 'JB')" v-if="detailRole || changeRole" class="btnBase blueBtn">详情</span>
              <span v-if="!detailRole && !changeRole" class="blueBtn disableBtn">详情</span>
            </template>
          </el-table-column>
        </el-table>
        <el-table :data="infoList" border style="width: 100% ;height:fit-content;padding-bottom: 7px;"
          v-if="activeName == 'third'" ref="multipleTable" @selection-change="handleSelectionChange" :key="activeName"
          @select-all="selectAll" class="realNameTable">
          <el-table-column type="selection" width="76" align="center" fixed="left">
          </el-table-column>
          <el-table-column width="210" align="center">
        ...
        <el-table :data="infoList" border style="width: 100% ;height:fit-content;padding-bottom: 7px;"
          v-if="activeName == 'first'" ref="multipleTable" @selection-change="handleSelectionChange" :key="activeName"
          @select-all="selectAll" class="realNameTable">
          <el-table-column type="selection" width="76" align="center" fixed="left">
          </el-table-column>
          <el-table-column width="210" align="center">
        ...
        <!-- <div class="infoTable unlock" v-if="tabPosition == '1'">
          <div class="tableHead">
            ...
            <span
              ><span>
                证件号<img
                  src="../assets/images/openEyes.png" v-show="false"
                  v-if="cardNumbStatus"
                  @click="changeHeadEyes('C')" />
                <img
                  src="../assets/images/closeEyes.png" v-show="false"
                  v-if="!cardNumbStatus"
            ...
            <span v-if="activeName == 'first'"
              >申请时间<i
                ...
                v-bind:class="{ blueBtn: applyDesc == 2 }"
                @click="changeOrder(false, 2)" /><i
                class="el-icon-caret-bottom"
                v-bind:class="{ blueBtn: applyDesc == 1 }"
                @click="changeOrder(false, 1)"
            /></span>
            <span v-if="activeName == 'second'"
              >通过时间<i
                class="el-icon-caret-top"
                v-bind:class="{ blueBtn: finishDesc == 2 }"
                @click="changeOrder(true, 2)" /><i
                class="el-icon-caret-bottom"
                v-bind:class="{ blueBtn: finishDesc == 1 }"
                @click="changeOrder(true, 1)"
            /></span>
...
export default {
  ...
  mounted() {
    ...
    this.exportRole = auth.hasPermi("home:personCarUnbind:export");
    this.detailRole = auth.hasPermi("home:personCarUnbind:detail");
    this.changeRole = auth.hasPermi("home:personCarUnbind:change");
    this.listRole = auth.hasPermi("home:personCarUnbind:list");
